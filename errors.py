...
the fourth element of the list which is not there and this throws an exception. 
...
# The final block always executes after normal termination of try block or after try block terminates due 
# to some exception.
